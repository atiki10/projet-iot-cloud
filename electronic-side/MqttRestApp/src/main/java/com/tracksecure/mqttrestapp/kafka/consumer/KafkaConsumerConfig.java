...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, SensorData> consumerFactory() {
        ...
        // JsonDeserializer is configured programmatically on the `deserializer` instance
        // to avoid configuring it both via setters and via properties (which causes
        // IllegalStateException). Do not duplicate JsonDeserializer settings here.
